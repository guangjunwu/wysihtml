...
;(function(wysihtml5) {
  var NODE_NAME = "SPAN";
  var ZERO_LENGTH_SPACE = "&#8288;";

  wysihtml5.commands.insertComment= {
    /**
     * Inserts an <img>
     * If selection is already an image link, it removes it
     *
     ...
     */
    exec: function(composer, command, value) {
      value = typeof(value) === "object" ? value : { "data-content": value };
      value = wysihtml5.lang.object({className: "ep_comment"}).merge(value).get()
